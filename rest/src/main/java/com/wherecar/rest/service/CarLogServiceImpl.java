...
public class CarLogServiceImpl implements CarLogService {
    ...
    @Override
    @Transactional(readOnly = true)
    public List<CarLogsResponse> getCarLogsByCarId(Long carId, int page, int size) {
        // Todo: 현재 사용자 정보 조회 (Admin, User에 따라 구분)
        // Todo: 현재 사용자의 Company 아이디 조회
        ...
        Page<CarLog> carLogPage = carLogRepository.findByCompanyIdAndCarId(userCompanyId, carId, pageRequest);
